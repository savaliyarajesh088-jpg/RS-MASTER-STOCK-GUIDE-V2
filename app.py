...
- 52W HIGH is NOT treated as ATH.
"""
...
for raw_symbol in portfolio["SYMBOL"]:
    ...
    # =====================================================
    # V3 E.M.S.
    # INDEPENDENT EXIT MANAGEMENT SYSTEM
    # =====================================================
    ...
    ems_input = {
        ...
        # SUPPORT
        # -------------------------------------------------
        # Actual support-breakdown mapping
        # not available here.
        ...
        # OUTPERFORMANCE
        # -------------------------------------------------
        # NIFTY benchmark mapping pending.
